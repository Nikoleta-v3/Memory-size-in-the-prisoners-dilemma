...
\affil[*]{glynatsine@cardiff.ac.uk}
...
The proof of Theorem~\ref{theorem_one} is given in the Supplementary Information.
...
The proof of Lemma~\ref{lemma:stability_of_defection} is given in the
