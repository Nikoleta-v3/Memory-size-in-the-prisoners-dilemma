...
more specifically, \textit{memory-one best responses}. It presents a series of novel
results which include proving that there is a compact way of identifying a memory-one best response to a group of opponents,
and moreover obtaining a condition for which in an
...
they interact with multiple opponents. These results have been
noted before~\cite{Hilbe2017, Pan2015, Stewart2013, Stewart2016}.
However, by specifically exploring the entire memory space-one strategies to
identify the optimal strategy for a variety of situations, this work hopes to
contribute to the discussion on the effectiveness of ZDs and on the
importance of adaptability, and to provide a framework for the continued
