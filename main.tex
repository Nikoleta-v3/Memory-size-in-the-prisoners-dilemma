...
>>>>>>> 6c109e271d554b079b584e4505642377bb01b2eb
...
\begin{theorem}\label{theorem:tournament utility}
    The expected utility of a memory one strategy \(p\in\mathbb{R}_{[0,1]}^4\)
...
The analytical formulation of Theorem~\ref{theorem:tournament utility} will be
