...
such as Moran Processes self interactions are key. %TODO Vince to add to the discussion and add weighting to 
                                                                                       % algorithm so as to make this clear that this CAN be used in an 
                                                                                       % evolutionary way. Possibly add discussion of how you could 
                                                                                       % update strategy in a Moran process so that it at every stage of 
                                                                                       % the process recalculates itself and carries on.
...
to fight back when being exploited. In~\cite{Hilbe2018} they showed that partner strategies are
selected in evolutionary settings when populations are large and relationships
stable and they allow for the evolution of cooperation. A best response memory-one strategy
