...
\(A ^ {(k)}_{11}\) is the long run utility of the best response player against itself.
\(A ^ {(k)}_{12}\) is the long run utility of the best response player against the opponent.
\(A ^ {(k)}_{11}\) is the long run utility of the opponent against the best response player.
\(A ^ {(k)}_{11}\) is the long run utility of the opponent against itself.

The matrix \(A ^ {(k)}\) is calculated using (\ref{eq:optimisation_quadratic})
...
(\(f_1^{(k)}\) is the fitness of the best response player, and \(f_2^{(k)}\) is
