...
though it never scored higher than that it's opponent. Tit for Tat provided
...
`states' the strategy could be in; \(CC, CD, DC, DD\). Therefore, a memory-one
...
research framework for the study of the IPD (\cite{axelrodproject} is described
in~\cite{Knight2016}). For smoothing the simulated results the
utility has been estimated in a tournament of 500 turns and 200
...
Two theoretical results were presented in this section, the formulation of
...
greater than zero which in this case these assumptions are not true
...
Lemma~\ref{lemma:stability_of_defection} is the last theoretical result
...
interactions. Finally, Section~\ref{subsection:longer_memory_best_response}
...
their behaviour reassures that the strategies will
...
This manuscript also presented experimental results. These results were mainly to
