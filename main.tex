...
given in the Appendix~\ref{appendix:tables}. Both values \(u\) and \(U\) appear to match,
shown in Table, thus we conclude that the formulation of Theorem~\ref{theorem:tournament_utility}
is correct.
