...
a defector \(p^*=(0, 0, 0, 0)\). The strategies \(p=(\frac{1}{2}, 0,
0, 0)\) and \(p=(\frac{1}{2}, 0, 0, \frac{1}{2})\) are also best responses.
The
...
Thus, SSE is defined as how far a strategy is from behaving as a ZD and thus a highand a high
