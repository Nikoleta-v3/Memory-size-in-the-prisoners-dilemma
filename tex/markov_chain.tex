...
\begin{document}
	...
	\draw (0) edge[out=20, in=160, ->, thick] node [above] {$1 - p_1$} (1);
    ...
    \draw (0) edge[out=180, in=135, ->, thick, loop] node [above, yshift=.1cm] {$p_1$} (0);
    \draw (2) edge[out=180, in=135, ->, thick, loop] node [above, yshift=.1cm] {$p_2$} (2);

    \draw (1) edge[out=0, in=45, ->, thick, loop] node [above, yshift=.1cm] {$p_3$} (1);
    \draw (3) edge[ out=0, in=45, ->, thick, loop] node [above, yshift=.1cm] {$p_4$} (3);
