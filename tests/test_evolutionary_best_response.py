...
def test_find_repeat_in_history_with_single_element():
    ...
    assert opt_mo.repeats_in_history(history_with_single_element_cycle) == 1
...
def test_find_repeat_in_history_with_two_elements():
    ...
    assert opt_mo.repeats_in_history(history_with_two_element_cycle) == 2
...
def test_find_repeat_in_history_with_three_elements():
    ...
    assert opt_mo.repeats_in_history(history_with_three_element_cycle) == 3
...
def test_find_repeat_in_history_no_cycle():
    ...
    assert opt_mo.repeats_in_history(history_with_no_cycle) == float("inf")
...
def test_find_repeat_cycle_from_the_beginning():
    ...
    assert opt_mo.repeats_in_history(history_with_cycle_from_the_beginning) == 2
