...
def write_results(index, method, list_opponents, params, turns, repetitions, method_params):
    ...
    best_response, theoretical, simulated = opt_mo.optimal_memory_one(method, opponents=list_opponents,
    ...
    opt_gambler, utility = opt_mo.train_gambler(method, opponents=list_opponents, turns=turns,
